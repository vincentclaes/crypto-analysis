...
DEFAULT_MAX_LOG_AGE_IN_DAYS = Variable.get("max_log_age_in_days",
                                           5)  # Length to retain the log files if not already provided in the conf. If this is set to 30, the job will remove those files that are 30 days old or odler
